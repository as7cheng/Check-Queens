...
# 131 "check_queens.c"
 ...
 for (int i = 0; i < rows; i++) {
  store_board[i] = malloc(sizeof (int) * cols);
        ...
        char *line = 
# 152 "check_queens.c" 3 4
                    ((void *)0)
# 152 "check_queens.c"
                        ;
        size_t len = 0;
        char *token = 
# 154 "check_queens.c" 3 4
                     ((void *)0)
# 154 "check_queens.c"
                         ;
        for (int i = 0; i < rows; i++) {
